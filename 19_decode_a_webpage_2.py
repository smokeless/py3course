...
the BeautifulSoup and requests libraries through the
...
myURL = 'http://www.vanityfair.com/society/2014/06/monica-lewinsky-humiliation-culture'
r = requests.get(myURL)
bs = BeautifulSoup(r.text)
for lines in bs.find_all('p'):
